...
public class MySQLConf {
	@Bean(destroyMethod = "close") protected DataSource dataSource() {
        ...
        dataSourceConfig.setJdbcUrl("jdbc:mysql://127.0.0.1:3306/data4?useUnicode=yes&characterEncoding=UTF-8&serverTimezone=UTC");
        dataSourceConfig.setUsername("root");
        dataSourceConfig.setPassword("hieu20021998");
